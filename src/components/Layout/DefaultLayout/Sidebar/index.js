...
const Sidebar = () => {
  ...
  return (
    <div className={cx("menu-container")}>
      <div className={cx("menu", { collapsed })}>
        <ul>
          <li><FontAwesomeIcon icon={faHome} className={cx("icon")} /><span>Đề xuất</span></li>
          <li><FontAwesomeIcon icon={faSearch} className={cx("icon")} /><span>Khám phá</span></li>
          <li><FontAwesomeIcon icon={faUserFriends} className={cx("icon")} /><span>Bạn bè</span></li>
          <li><FontAwesomeIcon icon={faUpload} className={cx("icon")} /><span>Tải lên</span></li>
          <li><FontAwesomeIcon icon={faBell} className={cx("icon")} /><span>Hoạt động</span></li>
          <li><FontAwesomeIcon icon={faCommentDots} className={cx("icon")} /><span>Tin nhắn</span></li>
          <li><FontAwesomeIcon icon={faVideo} className={cx("icon")} /><span>LIVE</span></li>
          <li><FontAwesomeIcon icon={faUser} className={cx("icon")} /><span>Hồ sơ</span></li>
          <li onClick={toggleSubMenu}>
            <FontAwesomeIcon icon={faEllipsisH} className={cx("icon")} /><span>Thêm</span>
          </li>
        </ul>
      </div>
      {submenuOpen && (
        <div className={cx("submenu")} style={{ left: collapsed ? "80px" : "250px" }}>
          <ul>
            <li><FontAwesomeIcon icon={faCoins} className={cx("icon")} />Nhận Xu</li>
            <li><FontAwesomeIcon icon={faMagic} className={cx("icon")} />Tạo hiệu ứng TikTok</li>
            <li><FontAwesomeIcon icon={faTools} className={cx("icon")} />Công cụ dành cho nhà sáng tạo</li>
            <li><FontAwesomeIcon icon={faLanguage} className={cx("icon")} />Tiếng Việt</li>
            <li><FontAwesomeIcon icon={faMoon} className={cx("icon")} />Chế độ tối</li>
            <li><FontAwesomeIcon icon={faCog} className={cx("icon")} />Cài đặt</li>
            <li><FontAwesomeIcon icon={faQuestionCircle} className={cx("icon")} />Phản hồi và trợ giúp</li>
            <li><FontAwesomeIcon icon={faSignOutAlt} className={cx("icon")} />Đăng xuất</li>
          </ul>
        </div>
      )}
    </div>
